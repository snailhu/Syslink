...
public class PBKDF2SHA256 {
    public static byte[] deriveKey( byte[] password, byte[] salt, int iterationCount, int dkLen )
        ...
        public static String getEncryptedPassword(String password,String salt) throws InvalidKeyException, NoSuchAlgorithmException{
        	byte passwd[] = deriveKey(password.getBytes(),salt.getBytes(),10000,50);
        	return toHex(passwd);
        }
