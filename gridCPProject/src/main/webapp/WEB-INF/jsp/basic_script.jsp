		...
		<script src="<%=request.getContextPath() %>/static/jqwidgets/jquery2.0.3.min.js"></script>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='<%=request.getContextPath() %>/static/assets/js/jquery-1.11.3.js'>"+"<"+"script>");
		</script>
		...
		<!--[if IE]>
		<script type="text/javascript">
		 window.jQuery || document.write("<script src='<%=request.getContextPath() %>/static/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");
		</script>
		<![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="<%=request.getContextPath() %>/static/assets/js/excanvas.min.js"></script>
		<![endif]-->
